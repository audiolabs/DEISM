...
def get_ref_paths_ARG(params, room_pra_deism):
    ...
    reflection_matrix = np.array(room_pra_deism.room_engine.reflection_matrix, dtype=np.float32)
    ...
    atten_all = np.asarray(room_pra_deism.room_engine.attenuations, dtype=np.complex64)
