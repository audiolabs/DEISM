...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showFunctionPopup(functionName, mouseX, mouseY) {
        ...
        if (!functionElement) {
            ...
            const functionInfo = extractComprehensiveFunctionInfo(functionElement, functionName);
    ...
    function generatePopupHTML(functionName, info) {
        ...
        // Uses Parameters
        if (info.usesParameters.length > 0) {
            html += `
                <div style="margin-bottom: 16px;">
            ...
            html += `
                <div style="margin-bottom: 16px;">
                    ...
                    <div style="background: #ffe8f0; padding: 12px; border-radius: 6px; border-left: 4px solid #e91e63;">
                        <span style="font-size: 13px; color: #555;">${info.algorithmDetails}</span>
                    </div>
                </div>
            `;
        }
