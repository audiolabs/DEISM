...
def batch_run_all_measurements():
    ...
    nc_temp = Dataset(str(real_sofa_path), 'r')
    ...
    for idx in range(total_measurements):
        ...
        model.params["posSource"] = src_pos
        model.params["posReceiver"] = rec_pos
        ...
        save_path = os.path.join(output_dir, f"validation_idx{idx}_LS{ls_id:02d}_MP{mp_id:02d}.png")
